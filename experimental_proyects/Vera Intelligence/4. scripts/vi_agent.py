...
def _build_extra_tools_section() -> str:
    ...
    if CLIENT_CONFIG.vector_search:
        items.append(
            ...
            "-'Hallazgos cualitativos', 'Patrones observados'- alcanza con UNA mención al principio "
            "del bloque (ej. como intro: '**En conversaciones reales:** se repiten estos patrones...' "
            "seguido de las viñetas SIN repetir la etiqueta en cada una) o directamente dejar que el "
            "título de la sección ya cumpla ese rol si es inequívoco.\n"
