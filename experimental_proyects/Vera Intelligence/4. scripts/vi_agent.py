...
def _build_extra_tools_section() -> str:
    ...
    if CLIENT_CONFIG.vector_search:
        items.append(
            ...
            "  - CUÁNDO: si tu respuesta trata sobre el desempeño de UN vendedor, tienda o equipo "
            "puntual (diagnóstico, coaching, seguimiento, 'cómo viene X'), usala -por default sí-. "
            "Excepción: una pregunta puramente agregada/comparativa (ranking, top-N, tendencia, "
            "distribución) aunque nombre varias personas. Resolvé primero con run_readonly_sql: es "
            "la fuente de los números y del criterio débil.\n"
            ...
            "iniciativa'. Esta comparación por situación NO es prosa a recortar: es el valor "
            ...
            "  - OTROS USOS (sin criterio/resultado): un ejemplo o caso puntual pedido, audio, o "
            "exploración abierta ('¿qué piden los clientes que no resolvemos?': query específica y "
            "accionable, nunca abstracta; agrupá 2-4 patrones con tus palabras y señalá lo que se "
            "repite entre tiendas/vendedores). Pedidos de audio sólo se resuelven con esta tool: la "
            "interfaz reproduce el audio de las conversaciones que vinieron de acá.\n"
